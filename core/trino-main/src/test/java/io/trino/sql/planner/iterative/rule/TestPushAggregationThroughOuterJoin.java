                ...
                .on(p -> p.aggregation(ab -> ab
                        .source(
                                p.join(
                                        ...
                                        ImmutableList.of(new EquiJoinClause(p.symbol("COL1", BIGINT), p.symbol("COL2", BIGINT), Comparison.Operator.EQUAL)),
        ...
        tester().assertThat(new PushAggregationThroughOuterJoin())
                .on(p -> p.aggregation(ab -> ab
                        .source(p.join(
                                ...
                                p.values(p.symbol("COL2", BIGINT)),
                                p.values(ImmutableList.of(p.symbol("COL1", BIGINT)), ImmutableList.of(ImmutableList.of(new Constant(BIGINT, 10L)))),
                                ImmutableList.of(new EquiJoinClause(p.symbol("COL2", BIGINT), p.symbol("COL1", BIGINT), Comparison.Operator.EQUAL)),
                                ImmutableList.of(p.symbol("COL2", BIGINT)),
                                ImmutableList.of(p.symbol("COL1", BIGINT)),
                                Optional.empty(),
                                Optional.empty(),
                ...
                .on(p -> p.aggregation(ab -> ab
                        .source(
                                p.join(
                                        ...
                                        ImmutableList.of(new EquiJoinClause(p.symbol("COL1"), p.symbol("COL3"), Comparison.Operator.EQUAL)),
        ...
        tester().assertThat(new PushAggregationThroughOuterJoin())
                .on(p -> p.aggregation(ab -> ab
                        .source(p.join(
                                ...
                                ImmutableList.of(new EquiJoinClause(new Symbol(BIGINT, "COL1"), new Symbol(BIGINT, "COL2"), Comparison.Operator.EQUAL)),
                                ImmutableList.of(p.symbol("COL1")),
                ...
                .on(p -> p.aggregation(ab -> ab
                        .source(
                                p.join(
                                        ...
                                        ImmutableList.of(new EquiJoinClause(p.symbol("COL1"), p.symbol("COL2"), Comparison.Operator.EQUAL)),
                                        ImmutableList.of(p.symbol("COL1")),
                                        ImmutableList.of(p.symbol("COL2")),
                                        Optional.empty(),
                                        Optional.empty(),
